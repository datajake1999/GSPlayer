...
AllowNoIcons=yes
LicenseFile=gpl.txt
OutputBaseFilename=GSPlayer9XSetup
Compression=lzma
...
[Files]
Source: "bin\eng\Win32\Release\GSPlayer2.exe"; DestDir: "{app}"; DestName: "GSPlayer2e.exe"
Source: "bin\jpn\Win32\Release\GSPlayer2.exe"; DestDir: "{app}"; Components: "japanese"
...
Source: "ResetConfig\Release\ResetConfig.exe"; DestDir: "{app}"; Components: "reset"
